...
exports.getCoupons = async (req, res, next) => {
  ...
  try {
    ...
    res
      .status(200)
      .json(
        generateResponse(200, true, "Coupons retrieved successfully", coupons)
      );
  } catch (error) {
    next(error);
  }
...
exports.postCoupon = async (req, res, next) => {
  try {
    ...
    res
      .status(201)
      .json(generateResponse(201, true, "Coupon created successfully", coupon));
  } catch (error) {
    console.log(error);
    next(error);
  }
...
exports.deleteCoupon = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .json(generateResponse(200, true, "Coupon deleted successfully"));
  } catch (error) {
    next(error);
  }
};
